...
## 動作環境
.NET Framework4.8 と Visual Studio 2022 runtime library が必要です。
...
#### MoreSendTo
他の場所にあるショートカットをメニューとして表示します。このアプリへのショートカットをSendToに置いて、そのショートカットのプロパティで他の場所を引数で指定します。
...
- ウェブサイト: <https://ambiesoft.github.io/webjumper/?target=sendtotools_jp_>
